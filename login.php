...
<table border=0>
      ...
      <tr valign='top'><td></td><td><input class = 'loginbutton' type='submit' name='login' value='Form_Login'></td><td></td></tr>
      <tr valign='top'><td></td><td><input class = 'loginbutton' type='submit' name='digestlogin' value='HTTP_DIGEST_Login'></td><td></td></tr>
</table>
</form>
<?php
